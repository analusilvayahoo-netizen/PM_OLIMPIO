...
export default function ConsultaAvaliacoesScreen({
  ...
  const filtradas = avaliacoes.filter((avaliacao) =>
    avaliacao.aluno.toLowerCase().includes(busca.toLowerCase())
  );
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.titulo}>Consulta de Avaliações</Text>
        ...
        {filtradas.map((avaliacao) => (
          <View key={avaliacao.id} style={styles.item}>
            <Text style={styles.nome}>{avaliacao.aluno}</Text>
            ...
            <View style={styles.acoes}>
              <TouchableOpacity
                ...
                onPress={() =>
                  navegar('editarAvaliacao', avaliacao)
                }
              >
